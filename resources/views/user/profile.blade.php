...
<nav class="navbar sticky-top bg-white navbar-expand-md navbar-light p-0">
    ...
    <div class="collapse navbar-collapse justify-content-between">
        ...
        <div class="ml-3">
            ...
            <form action="get_out/user" method="post">
                @csrf
        ...
        >
            ...
            <ul class="nav flex-column px-3">
                <li class="nav-item d-flex align-items-center">
                    ...
                    <a href="#" class="nav-link my-1 w-100">اطلاعات حساب کاربری</a>
                </li>
                <li class="nav-item">
                    <div class="d-flex align-items-center">
                ...
                <li class="nav-item d-flex align-items-center">
                    ...
                    <a href="#" class="nav-link my-1 w-100">بازدید های اخیر </a>
                </li>
            </ul>
            <div>متفرقه</div>
            <ul class="nav flex-column px-3">
                ...
                <li class="nav-item w-100">
                    ...
                    <div class="collapse" id="articlesSubmenu2">
                        <ul class="nav px-3">
                            ...
                            <li class="nav-item">
                                <a href="#" class="nav-link my-1 w-100">سوال ها</a>
                            </li>
                        </ul>
                    </div>
                </li>
